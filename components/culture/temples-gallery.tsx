// components/culture/temples-gallery.tsx
...
import { MapPin, Clock, Star, Camera, Info, ExternalLink, Building, History, ZoomIn, Users, Search, Filter, Navigation, Heart, Share, Landmark } from "lucide-react"
...
// Your temples data array here (same as before)
          ...
          <div className="space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
              <TabsList className="grid w-full grid-cols-4">
                <TabsTrigger value="overview">{t('temples.tabs.overview')}</TabsTrigger>
                <TabsTrigger value="architecture">{t('temples.tabs.architecture')}</TabsTrigger>
                <TabsTrigger value="history">{t('temples.tabs.history')}</TabsTrigger>
                <TabsTrigger value="visit">{t('temples.tabs.visit')}</TabsTrigger>
              </TabsList>
...
export function TemplesGallery() {
      ...
      {/* Scrollable Temples Grid Section */}
               <div className="mb-8">
                 <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-6 mb-8">
                   ...
                   <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-h-[700px] overflow-y-auto pr-2">
