            ...
            {resetSent ? (
              ...
              <form onSubmit={handleResetPassword} className="space-y-6">
                ...
                <button
                  type="button"
                  onClick={() => setShowResetForm(false)}
                  className="w-full text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white"
                >
                  Back to Login
                </button>
              </form>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center">
                <input 
                  ...
                  className="w-4 h-4 text-blue-600 border-gray-300 rounded dark:bg-gray-700" 
                />
